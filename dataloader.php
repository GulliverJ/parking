<?php
  ...
  try {
    ...
    $sql_statement = $connection->prepare('SELECT v.occupied, v.state_time, v.time_remaining, v.max_stay,
                                                  v.restricted, v.legally_occupied, v.nearest_unoccupied_bay,
                                                  r.start, r.end, r.hourly_charge
                                           FROM bay_data_view v 
                                           INNER JOIN bays b 
                                           ON v.bay_id = b.bay_id 
                                           INNER JOIN restrictions r 
                                           ON b.restriction_id = r.restriction_id 
                                           WHERE v.bay_id = 10');
